        ...
        <div className="data-picker">
            {events.map((event, index) => (
                <div key={index} className="data-picker__event">
                    <img src={event['Lien de l\'image']} alt={event['Titre de l\'offre']} className="data-picker__image" />
                    <div className="data-picker__details">
                        ...
                        <a href={event['Lien de l\'offre']} target="_blank" rel="noopener noreferrer" className="data-picker__link">Voir l'offre</a>
                    </div>
                </div>
            ))}
        </div>
